...
### Fixed
- Slim npm package (exclude `.npm-cache` and source files from publish)

## [0.3.0] - 2026-09-23

### Added
- Validation via the hosted validator at validator.agent-manifest.com (one npm package, no separate validator library)
...
- CLI version 0.3.0 — single published package (`@agentmanifest/cli` only)
